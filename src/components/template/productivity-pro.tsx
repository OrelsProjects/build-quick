...
import { BarChart2, Clock, Users, Zap, ChevronDown, ArrowRight } from "lucide-react"
      ...
      <main className="flex-1 w-full flex flex-col justify-start items-center">
          ...
          >
                ...
                <CardContent>
                  <div className="relative h-[300px] w-full overflow-hidden rounded-lg">
                    <motion.div
                      ...
                      animate={activeTab === "timeTracking" ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.8 }}
                    >
                      <div className="bg-white p-4 rounded-lg shadow-lg w-full max-w-md">
                        <h3 className="text-lg font-semibold mb-2">Current Task: Website Redesign</h3>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="relative h-[300px] w-full overflow-hidden rounded-lg">
                    <motion.div
                      className="absolute inset-0 flex items-center justify-center"
                      animate={activeTab === "dashboard" ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.8 }}
                    >
                      <div className="bg-white p-4 rounded-lg shadow-lg w-full max-w-md">
            ...
            <div className="mt-8 flex justify-center">
              <motion.button
                ...
                onClick={() => setActiveTab(activeTab === "timeTracking" ? "dashboard" : "timeTracking")}
        ...
        <section className="w-full flex justify-center items-center py-12 md:py-24 lg:py-32 bg-white">
          ...
          >
            ...
            <div className="grid gap-6 lg:grid-cols-3 lg:gap-12">
              <motion.div variants={fadeIn} className="flex flex-col items-center space-y-4 text-center">
                ...
                <p className="text-gray-500">Boost team efficiency by identifying and eliminating time-wasting activities.</p>
              </motion.div>
              <motion.div variants={fadeIn} className="flex flex-col items-center space-y-4 text-center">
                <motion.div whileHover={pulseAnimation}>
                  <Users className="h-12 w-12 text-blue-500" />
                </motion.div>
                <h3 className="text-xl font-bold">Better Resource Allocation</h3>
                <p className="text-gray-500">Optimize project staffing based on accurate time and productivity data.</p>
              </motion.div>
              <motion.div variants={fadeIn} className="flex flex-col items-center space-y-4 text-center">
                <motion.div whileHover={pulseAnimation}>
                  <Clock className="h-12 w-12 text-yellow-500" />
                </motion.div>
                <h3 className="text-xl font-bold">Improved Work-Life Balance</h3>
                <p className="text-gray-500">Ensure fair workloads and prevent burnout with insights into work patterns.</p>
              </motion.div>
            </div>
          </motion.div>
        </section>
        ...
        <section className="w-full flex justify-center items-center py-12 md:py-24 lg:py-32 bg-green-600">
          ...
          >
            <div className="flex flex-col items-center space-y-4 text-center text-white">
              ...
              <motion.div className="space-x-4" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button className="bg-white text-green-600 hover:bg-green-50">Start Free Trial</Button>
      ...
      <footer className="w-full py-6 bg-gray-100 flex justify-center items-center">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <motion.div className="flex items-center space-x-2" whileHover={pulseAnimation}>
              <Zap className="h-6 w-6 text-yellow-500" />
              <span className="font-bold">ProductivityPro</span>
            </motion.div>
